...
class StartFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        carViewModel.eventNetworkError.observe(
            viewLifecycleOwner,
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<Button>(R.id.filter_button).setOnClickListener { view ->
            view.findNavController().navigate(R.id.action_fragment_start_to_fragment_filter)
        }

        view.findViewById<FloatingActionButton>(R.id.map_button).setOnClickListener { view ->
            view.findNavController().navigate(R.id.action_home_to_fragment_map)
        }
    }
