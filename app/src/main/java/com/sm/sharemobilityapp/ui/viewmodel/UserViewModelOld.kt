...
class UserViewModelOld(private var userDao: UserDao): ViewModel() {
...
//        if (modelClass.isAssignableFrom(UserViewModelOld::class.java)) {
//            //@Suppress("UNCHECKED_CAST")
//            return UserViewModelOld(userDao) as T
//        }
